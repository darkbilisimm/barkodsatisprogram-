    ...
    public partial class fUrunGiris : Form
    {
        ...
        private void tBarkod_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode==Keys.Enter)
            {
                ...
                {
                    MessageBox.Show("Ürün Kayıtlı Değil, Lütfen Kayıt Yapınız");
                }
            }
        }
        ...
        private void bKaydet_Click(object sender, EventArgs e)
        {
            if (tBarkod.Text != "" && tUrunAdi.Text != "" && cmbUrunGrubu.Text != "" && tAlisFiyati.Text != "" && tSatisFiyati.Text != "" && tKdvOrani.Text != "" && tMiktar.Text != "")
            {
                if (db.Urun.Any(a => a.Barkod == tBarkod.Text))
                {
                    ...
                    guncelle.SatisFiyat = Convert.ToDouble(tAlisFiyati.Text);
                ...
                else
                {
                    ...
                    urun.SatisFiyat = Convert.ToDouble(tAlisFiyati.Text);
                ...
                Islemler.Stok_Hareket(tBarkod.Text, tUrunAdi.Text, "Adet", Convert.ToDouble(tMiktar.Text), cmbUrunGrubu.Text, lKullanici.Text);
                Temizle();
            }
            else
            {
